...
<section class="home-main">
    ...
    <div class="nav header-top-nav" style=" padding-left:20px; display: flex;align-items: center;justify-content: space-between;">
        ...
        <div class="responsive_nav ballon-menu">
            ...
            <a class="blog-btn desktop-only ballon-item" href="#" style="background-color: #FF007A; display:inline-block;"><?=translate('Guía');?></a>
            <a class="blog-btn desktop-only ballon-item" href="#" style="background-color: #FF007A; display:inline-block;"><?=translate('Fest');?></a>
            <a class="blog-btn desktop-only ballon-item" href="#" style="background-color: #FF007A; display:inline-block;"><?=translate('Chef');?></a>
            <a class="blog-btn desktop-only ballon-item" href="https://blog.mejorcadadia.com/" style="background-color: #FF007A; display:inline-block;"><?=translate('Hostels');?></a>
            <?php
    ...
    <div class="language-options-wrapper" style="display: flex;align-items: center;justify-content: flex-end;">
        <div class="dropdown language-switcher" style="display:inline-block;">
                ...
                <ul class="dropdown-menu" style="">
                            <?php foreach($languages as $code=>$name): if($code!=$userLanguage): ?>
                                <li><a class="dropdown-item" href="index.php?lang=<?=$code;?>"><img src="<?=SITE_URL;?>/assets/images/<?=$code;?>.png"> <?=$name;?></a></li>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-content" style="border-radius: 32px;">
                ...
                <div class="modal-body text-center pt-0">
                    ...
                    <h3> <?=translate('Bienvenido a MejorCadaDía');?></h3>
                    <p><?=translate('Rechaza los límites');?></p>
              
                    <div id="register-email-form">
                        <form id="email_check_part">
                            <div class="form-group">
                                <label class="fw-bold"><?=translate('Email');?></label>
                                <input type="email" id="reg_email" placeholder="<?=translate('Email de acceso');?>">
                                <div id="error_success_msg_reg_email" class="msg d-none"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label class="fw-bold"><?=translate('Contraseña');?></label>
                                <input type="password" id="reg_password" placeholder="<?=translate('Introduce Contraseña');?>">
                                <div id="error_success_msg_reg_password" class="msg d-none"></div>
                            </div>
                            <div class="form-group mt-3">
                                <label class="fw-bold"><?=translate('Fecha de Nacimiento');?></label>
                                <input type="date" id="reg_age" placeholder="<?=translate('Enter age');?>">
                                <div id="error_success_msg_reg_age" class="msg d-none"></div>
                            </div>
                            <div class="form-group mt-3">
                                <input class="mb-3" id="email_registration" type="button" value="<?=translate('Continúa');?>">
                            </div>
                        </form>
                        <div id="email_verification_part" style="display: none; width: 270px; margin: auto;">
                            <h5 class="text-center text-muted mb-4"><?=translate('Enter verification code');?></h5>
                            <input class="form-control mb-3" type="text" id="code" placeholder="<?=translate('Enter code');?>">
                            <div id="error_success_msg_verification" class="msg d-none"></div>
                            <button class="btn btn-primary w-100" id="email_verification_login"><?=translate('Verify');?></button>
                            <br />
                            <br />
                        </div>
                    </div>
                    <div class="login-option-buttons my-4" id="modal-register-options">
                        <div class="alert alert-white d-flex align-items-center" role="alert" onclick="showRegisterFrom()">
                            ...
                            <div>
                            <?=translate('Regístrate con Email address');?>
                            </div>
                        </div>
                        <div class="alert alert-white d-flex align-items-center" role="button" onclick="fbLogin();">
                            ...
                            <div>
                            <?=translate('Continuar con Facebook');?>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-white d-flex align-items-center" role="button" onclick="instaLogin()">
                            ...
                            <div>
                            <?=translate('Continuar con Instagram');?>
                            </div>
                        </div>
                        <div class="alert alert-white d-flex align-items-center" role="button" onclick="tiktokLogin()">
                            ...
                            <div>
                            <?=translate('Continuar con TikTok');?>
                            </div>
                        </div>
            ...
            <div class="modal-content" style="border-radius: 32px;">
                ...
                <div class="modal-body text-center pt-0">
                    ...
                    <form id="login_email_form">
                        <div class="form-group">
                            <label class="fw-bold"><?=translate('Email');?></label>
                            <input type="email" id="login-email" placeholder="<?=translate('Email de acceso');?>">
                            <div id="error_success_msg_email" class="msg d-none"></div>
                        </div>
                        <div class="form-group mt-3">
                            <label class="fw-bold"><?=translate('Contraseña');?></label>
                            <input type="password" id="login-password" placeholder="<?=translate('Introduce Contraseña');?>">
                            <div id="error_success_msg_password" class="msg d-none"></div>
                        </div>
                        <div class="form-group mt-3">
                            <input class="mb-3" id="email_login" type="button" value="<?=translate('Continúa');?>">
                        </div>
                        <div class="form-group">
                            <a href="javascript:void(0);" id="forgot_panel"><?=translate('Tu contraseña ¿No la recuerdas?');?></a>
                        </div>
                    </form>
                    </div>
                    <div class="forgot-form" id="forgot-form" style="display: <?= isset($forgot_error_msg) ? 'block' : 'none'; ?>;">
                    <h2><?=translate('Has olvidado tu contraseña');?></h2>
                    ...
                    <div class="accordion " id="accordionExample">
                        <div class="accordion-item">
                            ...
                            <?=translate('Contraseña por correo electrónico');?>
                            </button>
                            </h2>
                    ...
                    <span style="display: block;text-align: center; font-size: 13px; width: 259px;margin: 0 auto;">
                    <?=translate('Al continuar, aceptas los Términos de servicio de Mejorcadadia') ?> <a href="https://mejorcadadia.com/terms-and-conditions.php"><?=translate('Términos de servicio') ?></a> <?=translate('Y reconoce que has leído nuestra') ?> <a href="https://mejorcadadia.com/privacy-policy.php"><?=translate('política de privacidad') ?></a>
                    </span>
                </div>
            ...
            <div class="modal-content" style="border-radius: 32px;">
                ...
                <div class="modal-body text-center pt-0">
                    ...
                    <form id="login_email_check_part">
                        <div class="form-group">
                            <label class="fw-bold"><?=translate('Email');?></label>
                            <input type="email" id="login-email" placeholder="<?=translate('Enter Email');?>">
                            <div id="error_success_msg_email" class="msg d-none"></div>
                        </div>
                        <div class="form-group mt-3">
                            <label class="fw-bold"><?=translate('Password');?></label>
                            <input type="password" id="login-password" placeholder="<?=translate('Enter Password');?>">
                            <div id="error_success_msg_password" class="msg d-none"></div>
                        </div>
                        <div class="form-group mt-3">
                            <input class="mb-3" id="email_login" type="button" value="<?=translate('Continue');?>">
                        </div>
                        <div class="form-group">
                            <a href="javascript:void(0);" id="forgot_panel"><?=translate('¿Contraseña olvidada?');?></a>
                        </div>
                    </form>
                    <div class="forgot-form" id="forgot-form" style="display: <?= isset($forgot_error_msg) ? 'block' : 'none'; ?>;">
